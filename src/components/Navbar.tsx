    ...
    return(
        ...
        <div className="w-full flex justify-between items-center font-semibold">
            <div className=" flex items-center gap-2">
                <img onClick={() => navigate(-1)} className="w-8 bg-black p-2 rounded-2x1 cursor-pointer" src={assets.arrow_left} alt="Arrow Left Icon"></img>
                <img onClick={() => navigate(1)} className="w-8 bg-black p-2 rounded-2x1 cursor-pointer" src={assets.arrow_right} alt="Arrow Right Icon"></img>
            </div>
